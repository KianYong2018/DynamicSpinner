...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aaNumbers = new ArrayAdapter<String>(this,android.R.layout.simple_spinner_item,alNumbers);
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                switch(i){
                    case 0:
                        ...
                        String[] strArray = getResources().getStringArray(R.array.even_numbers);
                        alNumbers.addAll(Arrays.asList(strArray));
                        spn2.setSelection(2);
                        break;
                    case 1:
                        alNumbers.clear();
                        //Your code for item 2 selected
                        strArray = getResources().getStringArray(R.array.odd_numbers);
                        alNumbers.addAll(Arrays.asList(strArray));
                        spn2.setSelection(1);
                        break;
                }
